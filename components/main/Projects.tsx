      ...
      <div className="gap-10">
        ...
        <div className="h-full w-full flex flex-col md:flex-row gap-10 px-10">
          <ProjectCard
            ...
            src="/assets/projects/senhorita.png"
            title="Senhorita"
          ...
          <ProjectCard
            ...
            src="/assets/projects/divspeak.png"
          ...
          <ProjectCard
            ...
            src="/assets/projects/portfolio-game.png"
        ...
        <div className="h-full w-full flex flex-col md:flex-row gap-10 px-10">
          <ProjectCard
            ...
            src="/assets/projects/genoma.png"
          ...
          <ProjectCard
            ...
            src="/assets/projects/port-scan.png"
            title="Port Scanner"
          ...
          <ProjectCard
            themed={themed}
            link=""
            src="/assets/projects/ferias.png"
          ...
          <ProjectCard
            ...
            src="/assets/projects/litterae.png"
            title="Litterae"
